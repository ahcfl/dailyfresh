...
class OrderPayView(View):
    ...
    def post(self, request):
        ...
        # 初始化
        app_private_key_string = open("/home/cfl/bj18/item/dailyfresh/apps/order/app_private_key.pem").read()
...
class CommentView(LoginRequiredMixin, View):
    ...
    def post(self, request, order_id):
        ...
        for i in range(1, total_count + 1):
            ...
            # 获取评论的商品的内容
            content = request.POST.get('content_%d' % i, '') # cotent_1 content_2 content_3 没有返回 空
            try:
